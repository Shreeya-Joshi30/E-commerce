...
const LoginSignup = () => {
  ...
  const login = async()=>{
    ...
    let responseData;
    await fetch ('https://e-commerce-backend-7t6m.onrender.com/login',{
      method:'POST',
      headers:{
  ...
  const signup = async()=>{
    ...
    let responseData;
    await fetch ('https://e-commerce-backend-7t6m.onrender.com/signup',{
      method:'POST',
      headers:{
        Accept:'application/json',
        'Content-Type':'application/json',
    ...
    <div className='loginsignup'>
      <div className="loginsignup-container">
        ...
        <div className="loginsignup-agree">
          ...
          <p> By Continuing , I agree to all the terms of use and privacy policy.</p>
        </div>
      </div>
    </div>
  )
